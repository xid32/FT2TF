...
from models.modeling_outputs import BaseModelOutput, BaseModelOutputWithPastAndCrossAttentions, BaseModelOutputWithPoolingAndCrossAttentions
import transformers
...
class Blip2EncoderLayer(nn.Module):
    def __init__(self, config: transformers.Blip2Config):
        super().__init__()
        self.embed_dim = config.hidden_size
...
class Blip2VisionEmbeddings(nn.Module):
    def __init__(self, config: transformers.Blip2VisionConfig):
        super().__init__()
        self.config = config
        self.embed_dim = config.hidden_size
...
class Blip2PreTrainedModel(transformers.PreTrainedModel):
    """
...
class Blip2QFormerModel(Blip2PreTrainedModel):
    ...
    def __init__(self, config: transformers.Blip2QFormerConfig):
