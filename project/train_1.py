...
from models.model_1 import LLCFaceSy
    ...
    while global_epoch < nepochs:
        ...
        for step, (x, y, text_embedding, text_embedding_f, text_embedding_l) in prog_bar:
            ...
            if global_step == 1 or global_step % checkpoint_interval == 0:
                save_checkpoint(
                    model, optimizer, global_step, checkpoint_dir, global_epoch, hparams, global_step, mode)
...
def main():
    ...
    args = Args()
    print("Init Dataset...")
    train_dataset = Dataset(args, 'pretrain')
