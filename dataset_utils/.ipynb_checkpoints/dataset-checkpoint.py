...
class Dataset(data_utils.Dataset):
    ...
    def __getitem__(self, idx):
        while 1:
            ...
            text_embedding = np.load(os.path.join(self.args.video_data_root, self.linelist[idx] + "_all.npy"))
            text_embedding_f = np.load(os.path.join(self.args.video_data_root, self.linelist[idx] + "_first.npy"))
            text_embedding_l = np.load(os.path.join(self.args.video_data_root, self.linelist[idx] + "_last.npy"))
